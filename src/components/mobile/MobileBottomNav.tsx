...
export default function MobileBottomNav({ onNavigate, onOpenCart }: Props) {
    const { items } = useCart();
            ...
            <div className="flex items-center justify-around h-16 max-w-md mx-auto">
                {tabs.map(tab => (
                    <button
                        ...
                        className={`flex flex-col items-center justify-center gap-0.5 flex-1 py-1 relative transition-colors ${active === tab.id ? 'text-[#0039A6]' : 'text-gray-400'
                            }`}
